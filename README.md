...
```
cd existing_repo
git remote add origin https://git.foxminded.ua/foxstudent104037/hibernateintro.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.foxminded.ua/foxstudent104037/hibernateintro/-/settings/integrations)
